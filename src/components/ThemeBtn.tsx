...
const ThemeButton: React.FC<ThemeButtonProps> = ({
    ...
    const buttonContent = (
        <div className={`group ${className} border border-primary/50 hover:scale-105 shadow-lg hover:shadow-xl rounded-[9px] min-w-[157px] min-h-[41px] w-fit overflow-hidden flex hover:bg-primary bg-[#870c11] transition-all duration-200 items-center`}>
