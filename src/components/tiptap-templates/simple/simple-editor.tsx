...
export interface SimpleEditorProps {
  ...
  getEditorContent?: () => { json: JSONContent; html: string } | null;
}
...
export function SimpleEditor({ initialContent, onContentChange, getEditorContent }: SimpleEditorProps) {
  ...
  return (
    <EditorContext.Provider value={{ editor }}>
      <div 
        className="overflow-x-auto no-scrollbar sticky top-0 z-10"
      >
        <Toolbar
          className="bg-black"
          ref={toolbarRef}
