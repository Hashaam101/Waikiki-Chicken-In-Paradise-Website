...
function Featuring() {
  ...
  <div className='text-center text-h2 text-[var(--tt-color-text-gray)] mb-12 md:mb-[80px]'>
        ...
        <div className='grid grid-cols-2 gap-x-4 gap-y-8 md:flex md:justify-between md:items-center md:gap-0 self-stretch group text-var(--tt-color-text-gray);'>
          ...
          <div className='h-[80px] w-[1px] hidden md:block group-hover:rotate-8 transition-all duration-300' style={{background: 'color-mix(in oklab, var(--color-white) 25%, transparent)'}}></div>
          <div className='flex flex-col items-center gap-[10px] w-full'>
            <div className='h-[22px] w-[22px] aspect-square'>
          ...
          <div className='flex flex-col items-center gap-[10px] w-full'>
            ...
            <div className='text-normal3 text-center'>Vegan-Friendly Options</div>
          </div>
          <div className='h-[80px] w-[1px] hidden md:block group-hover:rotate-8 transition-all duration-300' style={{background: 'color-mix(in oklab, var(--color-white) 25%, transparent)'}}></div>
          <div className='flex flex-col items-center gap-[10px] w-full'>
            <div className='h-[22px] w-[22px] aspect-square'>
