        ...
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
          ...
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:ml-5'>
            ...
            <div className='text-normal4 md:text-normal3 text-grey text-center lg:text-left'>
              Crispy, golden Taiwanese-style chicken bites tossed with fragrant basil.
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
          ...
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:mr-5'>
            ...
            <div className='text-normal4 md:text-normal3 text-grey text-center lg:text-left'>
            Soft, juicy dumplings filled with seasoned meat — a classic Taiwanese bite that’s simple, hearty, and loved in Hawaii.
            </div>
          </div>
          <Image
            src="https://pixel.menusifu.com/674a336c694d346a53507453652b6d614b742b7345673d3d/20250212083624318Wosh.jpg"
      ...
      >
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
          ...
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:ml-5'>
            ...
            <div className='text-normal4 md:text-normal3 text-grey text-center lg:text-left'>
            Tender braised beef shank in a rich, aromatic broth with noodles — Taiwan’s national dish. Slow-cooked for depth, served with a kick of house chili crisp for those who dare.
            </div>
          </div>
        </div>
      </motion.div>
